...
bool Spline1dGenerator::Solve() {
  ...
  bool use_hotstart =
      last_problem_success_ && (sqp_solver_ != nullptr && num_param == last_num_param_ &&
  ...
  ADEBUG << "Spline1dGenerator QP solve time: " << (end_timestamp - start_timestamp) / 1000.0
         << " ms.";
